...
class WilddogStub implements WilddogInterface
{
    /**
     * @var null
     */
    ...
    private function _isBaseURIValid() {
      ...
      return new Error(($error == 0 ? true : false), 'Wilddog does not support non-ssl traffic. Please try your request again over https.');
    }
