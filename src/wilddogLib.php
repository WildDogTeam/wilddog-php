...
class WilddogLib implements WilddogInterface
{
    ...
    /**
     * Sets Base URI, ex: https://<appId>.wilddogio.com/path
     *
    ...
    /**
     * Writing data into Wilddog with a PUT request
     * HTTP 200: Ok
     *
    ...
    /**
     * Pushing data into Wilddog with a POST request
     * HTTP 200: Ok
     *
     * @param string $path Path
     * @param mixed  $data Data
    ...
    /**
     * Updating data into Wilddog with a PATH request
     * HTTP 200: Ok
     *
     * @param string $path Path
     * @param mixed  $data Data
